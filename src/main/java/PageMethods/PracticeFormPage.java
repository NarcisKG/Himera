...
public class PracticeFormPage extends BasePage {
    ...
    public PracticeFormPage typeFirstName (String textToType){
        ...
        typeText(textToType, By.xpath(getLocator(Locators.INPUT_BY_ID, Attributes.PRACTICE_FORM_FIRST_NAME)));
        return this;
    }

    public PracticeFormPage typeLastName (String textToType){
        typeText(textToType,By.xpath(getLocator(Locators.INPUT_BY_ID, Attributes.PRACTICE_FORM_LAST_NAME)));
        return this;
    }

    public PracticeFormPage typeUserEmail (String textToType){
        typeText(textToType,By.xpath(getLocator(Locators.INPUT_BY_ID, Attributes.PRACTICE_FORM_EMAIL)));
        return this;
    }

    public PracticeFormPage verifyFirstName(String expectedName){
        Assertions.assertEquals(expectedName,
                getElementText(By.xpath(getLocator(Locators.INPUT_BY_ID, Attributes.PRACTICE_FORM_FIRST_NAME))),
    ...
    public PracticeFormPage verifyLastName(String expectedLastName){
        Assertions.assertEquals(expectedLastName,
                getElementText(By.xpath(getLocator(Locators.INPUT_BY_ID, Attributes.PRACTICE_FORM_LAST_NAME))),
